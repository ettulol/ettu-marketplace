...
| --- | --- | --- |
| [animate_channel_episode](#animate_channel_episode) | `characters:write` | episode: UUID; expected_version: integer; request_key: UUID; seconds_per_scene?: 4 \| 8 \| 12 = 8 |
