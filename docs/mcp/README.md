...
My Profile defaults to **My characters**. Its **Settings** tab contains private Clerk account details and existing assistant connection controls. Visitors continue to see the public creator profile.
